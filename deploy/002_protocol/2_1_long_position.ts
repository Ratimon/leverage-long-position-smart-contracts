...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
    ...
    let isInvert;
    let collateralizationOracleAddress;
    ...
    isInvert = true
    collateralizationOracleAddress = (await get('OracleChainlinkWrapper_USD_per_ETH')).address;
    ...
    Args[`collateralizationOracle`] = collateralizationOracleAddress;
